...
let playOrPauseButton = document.querySelector('playerButton');
const playButtonBar = document.querySelector(".player progress-bar-button");
const remainingTimeTimer = document.querySelector("remaining-time");
