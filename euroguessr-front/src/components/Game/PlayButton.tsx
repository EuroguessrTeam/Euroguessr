...
import {
  setAttempt,
  setSkipButtonCounter,
  setWin,
  useGlobalState,
} from "../../services/useGlobalState";
...
export function PlayButton({
  ...
  function loadingIcon(): ReactNode {
    return (
      <svg
        ...
        strokeWidth="2.5"
        stroke="white"
        className="w-[65%] h-[65%] animate-spin"
      >
        <path
          strokeLinecap="round"
  ...
  return (
    <>
      <button
        onClick={toggleSong}
        className={`${isListening ? "animate-wiggle" : ""} ${className}`}
      >
