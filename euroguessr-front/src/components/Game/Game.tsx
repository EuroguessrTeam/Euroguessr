    ...
    <>
      ...
      <div className="z-10 relative h-[44.87vh] flex mb-[4vh] mt-[6.5vh] overflow-hidden">
        ...
        <div className="w-[66.68%] h-full flex flex-col justify-between items-center">
          ...
          {/* Play Button */}
          <PlayButton className="flex justify-center items-center h-[15vh] w-[15vh] bg-pink rounded-full border-4 hover:scale-110 transition ease-in-out duration-200 shadow-2xl" />
